...
La integración está preparada, pero requiere un proyecto Supabase propio. GitHub Pages sirve la web; Supabase guarda la biblioteca privada de cada cuenta.
...
La integración con el servicio real no puede comprobarse hasta configurar un proyecto. Las pruebas incluidas verifican la combinación y el flujo con un servicio simulado; no sustituyen la prueba de permisos y correo en Supabase.
